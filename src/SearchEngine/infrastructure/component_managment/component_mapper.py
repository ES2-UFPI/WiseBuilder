...
def component_to_bd_object(component: Component):
    ...
    return (
        ComponentInstance(**mapped_comp_dict),
        specific_inst_cls(**mapped_specific_dict),
    )


def bd_object_to_component(
    component_base: ComponentInstance, component_specific
) -> Component:
    ...
    mapped_specific_dict = _map_from_to(
        component_specific, specific_inst_attrs, specific_attrs
    )
